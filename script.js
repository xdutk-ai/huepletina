...
updatePhysics();
// ... [Твой оригинальный код JavaScript оставляешь без изменений] ...

// Добавляем поддержку Touch в самый конец файла, не меняя остальное:
...
window.addEventListener('touchmove', (e) => {
    if (isDragging) {
        ...
        velocityX = (touch.clientX - lastX) * 1.5;
        velocityY = (touch.clientY - lastY) * 1.5;
        alienX = touch.clientX - 60;
        alienY = touch.clientY - 60;
        lastX = touch.clientX;
        lastY = touch.clientY;
        e.preventDefault();
    }
